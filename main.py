...
def attack(char_name: str, char_class: str) -> str:
    """Выбирает тип атаки и показывает урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет урон при защите для каждого игрока."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает героев игры,их возможности и проводит тренеровку."""    
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предоставляет выбор персонажа,описывает общие способности и характер."""
